        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <Logo
              withWordmark
              className="h-9 w-9"
              wordmarkClassName="font-display text-xl font-bold tracking-tight"
            />
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <a href="#features" className="hover:text-brand-violet">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="hover:text-brand-violet">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#faq" className="hover:text-brand-violet">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <a href="#" className="hover:text-brand-violet">
                  Privacy
                </a>
              </li>
              <li>
