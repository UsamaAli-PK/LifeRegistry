        ...
        >
          <div onClick={(e) => e.stopPropagation()} className="w-full max-w-xl">
            <Command
              ...
              className="glass-card rounded-2xl border border-border shadow-2xl"
            >
              ...
              <Command.List className="max-h-[60vh] overflow-y-auto p-2">
                ...
                <Command.Group
                  heading="Jump to"
                  className="px-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:font-mono [&_[cmdk-group-heading]]:text-[10px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-widest [&_[cmdk-group-heading]]:text-muted-foreground"
                >
