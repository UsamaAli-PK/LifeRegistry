...
export const Route = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage your profile, default currency, and reminder lead time.",
      },
    ],
  }),
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) => savePrefs({ ...prefs, currency: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) => savePrefs({ ...prefs, leadDays: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
          ...
          <div className="mt-6 rounded-3xl border border-brand-coral/30 bg-brand-coral/5 p-6 sm:p-8">
            <div className="flex items-center justify-between">
              <h2 className="font-display text-2xl font-bold tracking-tight text-brand-coral">
                Demo controls
              </h2>
            ...
            <div className="mt-6 flex flex-col gap-3 border-t border-brand-coral/20 pt-6 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Restore the seeded registry exactly as it shipped.
                </p>
              </div>
              <Button
